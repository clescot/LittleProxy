...
public class ThreadPoolConfiguration {
  ...
  /**
   * Set the number of client-to-proxy worker threads to create. Worker threads perform the actual
   * processing of client requests. The default value is {@link
  ...
  /**
   * Set the number of acceptor threads to create. Acceptor threads accept HTTP connections from the
   * client and queue them for processing by client-to-proxy worker threads. The default value is
  ...
  /**
   * Set the number of proxy-to-server worker threads to create. Proxy-to-server worker threads make
   * requests to upstream servers and process responses from the server. The default value is {@link
