...
abstract class ConnectionFlowStep<T extends HttpObject> {
   ...
   * can be overridden.
   *
   * <p>If this step modifies the pipeline, for example by adding/removing handlers, it's best to
   ...
   *
   * <p>The default implementation ignores the message and logs this, since we weren't really
   * expecting a message here.
   *
   * <p>Some {@link ConnectionFlowStep}s do need to read the messages, so they override this method
   * as appropriate.
   *
