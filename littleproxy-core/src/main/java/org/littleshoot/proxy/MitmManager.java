...
public interface MitmManager {
   ...
   * serverSslSession.
   *
   * <p>The serverSslSession is provided in case this method needs to inspect the server's
   * certificates or something else about the encryption on the way to the server.
   *
   * <p>This is the place where one would implement impersonation of the server by issuing
